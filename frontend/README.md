# MaghrebPass MVP - Frontend React

Interface React + Vite pour consommer l'API Laravel MaghrebPass.

## Fonctionnalites couvertes

- Pages publiques: matchs, hotels, restaurants, attractions.
- Pages detail: `/matches/:id`, `/hotels/:id`, `/restaurants/:id`, `/attractions/:id`.
...
- Connexion rapide avec les comptes demo.
- Favoris utilisateur: ajout, consultation, suppression.
- Profil utilisateur modifiable.
- Panneau admin: compteurs, utilisateurs, CRUD contenus principaux.
