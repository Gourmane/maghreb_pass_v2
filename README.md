...
- Gestion des favoris, reservations et trip planner
...
- Pour un demo public ou production, garder `APP_DEBUG=false`, `SESSION_ENCRYPT=true` et generer un `APP_KEY` propre a l'environnement.
